...
- The AI agent cant create the design itself. But it gave me a sample design and taught me how to implement it. I implemented my own design by looking on templates and making existing software designs as my inspiration.  
...
- The AI agent didn't meet my expectations. I think it's approach was too simple and not user-friendly. I think it's approach was also not modern and user-friendly. 
 
### **What you learned or the decision you made as a result**
 
- I think UI designing a good UI/UX is one of AI's weakness.
